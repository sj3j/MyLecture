        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 overflow-hidden rounded-xl bg-sky-50 dark:bg-sky-900/20 flex items-center justify-center">
              {/*
                The transparent mark, not /icons/icon-192.png: those carry the
                white launcher plate, which would read as a white box inside this
                tinted container. No onError fallback either -- this is a
                precached local asset, so unlike the remote URL it replaced it
                cannot 404 offline.
              */}
              <img src="/icons/logo-mark.png" alt={t.appName} className="w-8 h-8 object-contain" />
            </div>
